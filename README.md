...
11.	If the playbook has successfully finished, next step is to log in to the Kubernetes Master host; switch to your user and run this command in the /csi-vxflex/dell-csi-helm-installer/ folder: <br> ./csi-install.sh --namespace=vxflexos --values=../helm/myvalues.yaml --skip-verify-node <br> 
...
<br>c.	To delete the pvc run ‘kubectl delete pvc cassandra-db-test-0’ <br>
